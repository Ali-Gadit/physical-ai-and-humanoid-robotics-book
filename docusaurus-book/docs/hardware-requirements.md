...
### RAM
- **Minimum**: 32 GB DDR5
- **Recommended**: 64 GB DDR5 (32 GB is the absolute minimum, but will crash during complex scene rendering)
...
- **Recommended**: Generic USB IMU (BNO055)

**Note**: Often built into the RealSense D435i or Jetson boards, but a separate module helps teach IMU calibration.

### Voice Interface
- **Recommended**: A simple USB Microphone/Speaker array (e.g., ReSpeaker) for the "Voice-to-Action" Whisper integration.
...
- **Option 1**: Unitree G1 (~$16k)
- **Option 2**: Robotis OP3 (older, but stable, ~$12k)
