...
<BilingualChapter>
  ...
  <div className="urdu">
    ...
    ہم Gazebo Fortress (Ignition) استعمال کرتے ہیں۔
    ...
    ایک خالی دنیا شروع کرنے کے لیے:

    ```bash
    ign gazebo empty.sdf
    ```

    ## روبوٹ کو اسپون (Spawning) کرنا

    آپ `ros_gz_sim` سے `create` نوڈ کا استعمال کرتے ہوئے اپنے URDF ماڈل کو Gazebo میں spawn کر سکتے ہیں۔
