...
<BilingualChapter>
  ...
  <div className="urdu">
    # اصطلاحات کی فرہنگ (Glossary of Terms)

    *   **Actuator (ایکچیو ایٹر)**: ایک موٹر یا آلہ جو روبوٹ کو حرکت دیتا ہے۔
    *   **Algorithm (الگورتھم)**: مسئلہ حل کرنے کے لیے ہدایات کا ایک سیٹ۔
    *   **Autonomous (خودمختار)**: بغیر انسانی مداخلت کے کام کرنے کی صلاحیت۔
    *   **Degree of Freedom (DOF)**: حرکت کی آزادی کی ایک سمت۔
    *   **Kinematics (کینی میٹکس)**: حرکت کا مطالعہ (بغیر قوتوں کے)۔
    *   **Lidar**: لیزر کا استعمال کرتے ہوئے فاصلے کی پیمائش کرنے والا سینسر۔
    *   **Localization (لوکلائزیشن)**: روبوٹ کا نقشے میں اپنی پوزیشن کا تعین کرنا۔
    *   **Mapping (میپنگ)**: ماحول کا نقشہ بنانا۔
    *   **Odometry (اوڈومیٹری)**: وہیل کی گردش سے روبوٹ کی حرکت کا اندازہ لگانا۔
    *   **Perception (پرسیپشن)**: سینسر ڈیٹا کو سمجھنے کا عمل۔
    *   **ROS (روبوٹ آپریٹنگ سسٹم)**: روبوٹکس کے لیے مڈل ویئر۔
    *   **SLAM**: Simultaneous Localization and Mapping (ایک ہی وقت میں لوکلائزیشن اور میپنگ)۔
    *   **Teleoperation (ٹیلی آپریشن)**: دور سے روبوٹ کو کنٹرول کرنا۔
    *   **URDF**: Unified Robot Description Format (روبوٹ کی تفصیل کا فارمیٹ)۔
  </div>
</BilingualChapter>