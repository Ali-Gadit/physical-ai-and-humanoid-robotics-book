...
<BilingualChapter>
  ...
  <div className="urdu">
    ...
    ہر ہفتے کے مواد پر آن لائن کوئز۔

    *   **فارمیٹ**: متعدد انتخابی سوالات (MCQs)، مختصر کوڈنگ کے مسائل۔
    *   **مقصد**: نظریاتی تفہیم کو یقینی بنانا۔

    ## 2. پروجیکٹس (50%)

    چار ماڈیول پروجیکٹس، ہر ایک کا وزن 12.5% ہے۔

    *   **پروجیکٹ 1**: کسٹم ROS 2 نوڈز اور مواصلات۔
    *   **پروجیکٹ 2**: Gazebo میں روبوٹ اور ماحول کی سیمولیشن۔
    *   **پروجیکٹ 3**: Isaac ROS کے ساتھ نیویگیشن اور پرسیپشن۔
    *   **پروجیکٹ 4**: مکمل VLA پائپ لائن۔

    ## 3. کیپ اسٹون پروجیکٹ (20%)

    خودمختار ہیومنائیڈ (Autonomous Humanoid) کا نفاذ۔

    *   **معیار**: فعالیت (40%)، کوڈ کا معیار (30%)، دستاویزات (30%)۔
  </div>
</BilingualChapter>