...
<BilingualChapter>
  ...
  <div className="urdu">
    # ہفتہ 11-12: ہیومنائیڈ روبوٹ کی ترقی

    ## جائزہ

    Physical AI اور ہیومنائیڈ روبوٹکس کورس کے ہفتہ 11-12 میں خوش آمدید! ان آخری ہفتوں کے دوران، آپ ہیومنائیڈ روبوٹکس کے خصوصی شعبے میں گہرائی میں جائیں گے، جس میں انسان نما روبوٹس کی جانب سے پیش کردہ منفرد چیلنجوں اور مواقع پر توجہ مرکوز کی جائے گی۔ ہیومنائیڈ روبوٹس مکینیکل انجینئرنگ، کنٹرول تھیوری، اور علمی سائنس کے ایک دلچسپ سنگم کی نمائندگی کرتے ہیں، جو انسانی ماحول میں کام کرنے کے لیے ڈیزائن کیے گئے ہیں جبکہ حرکت اور تعامل کے انسانی اصولوں کا فائدہ اٹھاتے ہیں۔

    ## سیکھنے کے مقاصد

    ہفتہ 11-12 کے اختتام تک، آپ اس قابل ہو جائیں گے:

    1. ہیومنائیڈ روبوٹس کے بائیو مکینکس اور ڈیزائن کے اصولوں کو سمجھیں۔
    2. پیچیدہ حرکات کے لیے انورس کینی میٹکس (inverse kinematics) کے حل نافذ کریں۔
    3. دو ٹانگوں پر چلنے کے لیے توازن اور لوکوموشن کنٹرول الگورتھم تیار کریں۔
    4. ہنر مندانہ ہیرا پھیری کے نظام (dexterous manipulation systems) کو ڈیزائن اور کنٹرول کریں۔
    5. آبجیکٹ کے تعامل کے لیے پرسیپشن سسٹمز کو ضم کریں۔
    6. انسان اور روبوٹ کے تعامل کے پروٹوکولز کو نافذ کریں۔
    7. سیمولیشن اور حقیقی دنیا کے منظرناموں میں ہیومنائیڈ روبوٹ کے رویوں کی تصدیق کریں۔
  </div>
</BilingualChapter>
