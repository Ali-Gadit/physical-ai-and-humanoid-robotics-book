...
<BilingualChapter>
  ...
  <div className="urdu">
    ...
    ہفتہ 8-10 کے دوران، طلباء NVIDIA Isaac پلیٹ فارم کا مطالعہ کریں گے، جس میں فوٹو ریئلسٹک سیمولیشن کے لیے Isaac Sim، ہارڈ ویئر تیز رفتار ادراک اور نیویگیشن کے لیے Isaac ROS، اور دو ٹانگوں والی ہیومنائیڈ حرکت کے لیے راستے کی منصوبہ بندی (path planning) کے لیے Nav2 پر توجہ دی جائے گی۔ یہ مرحلہ طلباء کو NVIDIA کے جدید ترین روبوٹکس پلیٹ فارم کا استعمال کرتے ہوئے اعلی درجے کی AI سے چلنے والے ادراک اور ہیرا پھیری کے نظام سے متعارف کراتا ہے۔

    ## سیکھنے کے مقاصد

    ہفتہ 8-10 کے اختتام تک، طلباء اس قابل ہو جائیں گے:

    1. فوٹو ریئلسٹک سیمولیشن کے لیے NVIDIA Isaac Sim انسٹال اور کنفیگر کریں۔
    2. Isaac Sim کا استعمال کرتے ہوئے AI ماڈلز کی تربیت کے لیے مصنوعی ڈیٹا تیار کریں۔
    3. Isaac ROS کا استعمال کرتے ہوئے ہارڈ ویئر تیز رفتار ادراک کو نافذ کریں۔
    4. VSLAM (Visual SLAM) اور نیویگیشن کے لیے Isaac ROS استعمال کریں۔
    5. دو ٹانگوں والی ہیومنائیڈ حرکت کے لیے راستے کی منصوبہ بندی کے لیے Nav2 کو ترتیب دیں۔
    6. ہیومنائیڈ روبوٹکس کے لیے Sim-to-Real منتقلی کی تکنیکوں کو سمجھیں۔
    7. ریئل ٹائم روبوٹک پروسیسنگ کے لیے GPU ایکسلریشن کا فائدہ اٹھائیں۔
    8. Isaac پلیٹ فارم کو ROS 2 ایکو سسٹم کے ساتھ مربوط کریں۔
  </div>
</BilingualChapter>